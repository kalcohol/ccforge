...
_forge_define_tristate_option(FORGE_ENABLE_FORGE_ACCEL_CPU AUTO "Enable forge::accel CPU reference backend when available")
...
set(FORGE_HAS_FORGE_ACCEL_MOCK_BACKEND OFF)
set(FORGE_HAS_FORGE_ACCEL_CPU_BACKEND OFF)
if("${FORGE_ENABLE_FORGE_ACCEL}" STREQUAL "OFF")
    message(STATUS "CC Forge: forge::accel backends disabled")
elseif(FORGE_ENABLE_FORGE_RUNTIME AND FORGE_ENABLE_FORGE_RESOURCE_POLICY)
    set(FORGE_HAS_FORGE_ACCEL_BACKEND ON)
    set(FORGE_HAS_FORGE_ACCEL_MOCK_BACKEND ON)
    message(STATUS "CC Forge: forge::accel mock backend enabled")
    if("${FORGE_ENABLE_FORGE_ACCEL_CPU}" STREQUAL "OFF")
        message(STATUS "CC Forge: forge::accel CPU backend disabled")
    else()
        set(FORGE_HAS_FORGE_ACCEL_CPU_BACKEND ON)
        message(STATUS "CC Forge: forge::accel CPU backend enabled")
    endif()
elseif("${FORGE_ENABLE_FORGE_ACCEL_CPU}" STREQUAL "ON")
    message(FATAL_ERROR "FORGE_ENABLE_FORGE_ACCEL_CPU=ON requires FORGE_ENABLE_FORGE_ACCEL not OFF, FORGE_ENABLE_FORGE_RUNTIME=ON, and FORGE_ENABLE_FORGE_RESOURCE_POLICY=ON")
